...
$dataconfig = mysql_pconnect($servername, $dbusername, $dbpassword) or trigger_error(mysql_error(),E_USER_ERROR);
...
define('COPYRIGHT', '&copy; '.date("Y") .' <a href="'.APP_URL.'" target="_blank">'. APP_NAME .'</a> '.base64_decode('57ea5LiK5a6i5pyN57O757Wx').'(v'. APP_VERSION . ')');
