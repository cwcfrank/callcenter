...
<li>升級過程一般是先將升級包解壓後, 設置FTP工具以 <span class=note>二進制方式</span> 上傳到網站替換原文件, 然後在後台運行升級程序.</li>
<li>建議: 升級完成後刪除upgrade目錄內的所有文件.</li>
</ul>
</div>';
...
<br><br><font class=blue>系統升級成功! 建議刪除升級文件.</font><br><br><br>
<input type="submit" name="d​​eletefiles" value="刪除升級文件"><br><br>
</form>';
}else{
echo '<form method="post" action="admin.upgrade.php">
<input type="hidden" name="action" value="upgraderunning">
當前使用中的版本是: ' . APP_VERSION . '<br>
