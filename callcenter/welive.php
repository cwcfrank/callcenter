...
if($_CFG['cActived']){
	...
	"<div id=\"welive-closeDiv\" style=\"z-index:1;width:85px;height:72px;top:150px;right:0px;display:' . Iif($panel_status, 'block', 'block'). ';\">" +

	"<div style=\"width:60px;height:60px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''.TURL.'images/panel_open_bg.png\', sizingMethod=\'scale\'); !important;background:;\"><div style=\"position:absolute;right:12px;top:12px;\"><a onClick=\"welive_open_panel();return false;\" style=\"cursor:pointer;\" title=\"Open Panel\"><img src=\"'.TURL.'images/panel_open.png\" style=\"border:0;border-radius:10px;\" onMouseOver=\"this.src=\''.TURL.'images/panel_open2.png\';\" onMouseOut=\"this.src=\''.TURL.'images/panel_open.png\';\"></a></div></div></div>" +

	"<div id=\"welive-righDiv\" style=\"z-index:200008;top:79px;right:0px;display:' . Iif($panel_status, 'none', 'none'). ';\">" +
	...
	var welive_panel_main = "<div style=\"width:144px;height:100%;padding:0 12px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''.TURL.'images/panel_main.png\', sizingMethod=\'scale\');background:url(\''.TURL.'images/panel_main.png\') !important;background:;\"><div style=\"position:relative;width:363px;height:100%;background:#fff;border:1px solid #666;padding:0;margin:0;\"><iframe id=\"welive_main_frame\" src=\"'.BASEURL.'online.php\" frameBorder=\"0\" style=\"margin:0;padding:0;width:100%;overflow:hidden;border:none;background:#FFF;\" scrolling=\"no\" height=\"450\"></iframe></div></div>";
