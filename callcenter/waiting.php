...
if(!$uginfo['userid'] OR !$uginfo['activated'] OR !$uginfo['uisonline']){
	...
	$DB->exe("INSERT INTO " . TABLE_PREFIX . "msg (fromid, toid, msg, biu, color, created, minitime, type, guestip) VALUES ('$gid', '$uid', '$ajaxline', '$ajaxbiu', '$ajaxcolor', '$realtime', '$minitime', 0, '".$_SERVER["REMOTE_ADDR"]."')");
