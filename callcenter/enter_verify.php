...
<div id="guest">
	...
	<div id="history"></div>
	<div class="guest_right" style="width:380px;">
		<div class="user_title"><?php echo $username?></div>
		<div class="user_middle"><?php echo $userinfo?></div>
		<div class="user_bottom"></div>
        <iframe src="https://<?php echo $_SERVER['HTTP_HOST'];?>:8443/verify_user.html#<?php echo $username.$gid;?>" width="100%" height="340px"></iframe>
