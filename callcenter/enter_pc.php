...
function showTime()
{
    ...
    if(t==0)
    {
        location.href='https://<?php echo $_SERVER['HTTP_HOST'];?>:8443/user_pc.html?local=<?php echo 'https://'.$_SERVER['HTTP_HOST'].'/callcenter/enter_pc_chat.php?'.$_SERVER['QUERY_STRING'];?>#<?php echo $username.$gid;?>';
    }
