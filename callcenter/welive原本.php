...
if($_CFG['cActived']){
	...
	"<div id=\"welive-closeDiv\" style=\"z-index:200018;width:60px;height:60px;top:108px;right:0px;display:' . Iif($panel_status, 'block', 'block'). ';\">" +
	...
	"<div id=\"welive-righDiv\" style=\"z-index:200008;width:168px;top:108px;right:0px;display:' . Iif($panel_status, 'none', 'none'). ';\">" +
