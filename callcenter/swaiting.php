...
if($gid AND $act == 'sending'){ //发表信息
	...
	$DB->exe("INSERT INTO " . TABLE_PREFIX . "msg (fromid, toid, msg, biu, color, created, minitime, type, guestip) VALUES ('$uid', '$gid', '$ajaxline', '$ajaxbiu', '$ajaxcolor', '$realtime', '$minitime', 1, '".$_SERVER["REMOTE_ADDR"]."')");
