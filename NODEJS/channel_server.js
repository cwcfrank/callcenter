...
var httpsKeyPath = process.env.HTTPS_KEY || '/usr/local/src/node/server.key';
var httpsCertPath = process.env.HTTPS_CERT || '/usr/local/src/node/server.crt';
