...
window.onload = function () {
	...
	loding = document.getElementById("loding_font");
    ...
    joinButton.onclick = function (evt) {
		    ...
		    // 訪客點擊Call按鈕後圖示將停止
			joinButton.style.background = "url(user-call.png)";
			joinButton.style.width = "40px";
			joinButton.style.height = "40px";	
					         
			// 訪客點擊Call按鈕畫面呈現LODING				                                                                                                                                                                            
    		loding.style.position = "absolute";	
			loding.style.zIndex = "9999";	
			loding.style.left = "40%";	
			loding.style.top = "25%";	
			loding.innerHTML='<img src="loadingBar.gif">';
...
//通話10分鐘自行斷線
//var CountDownSecond = 36000; //讓倒數計時器一開始的數字是10，10秒鐘後關閉視窗
//CountDown();
//function CountDown() {
